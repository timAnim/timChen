          ...
          <section>
            <ol class='shade-as-card' type='expand'>
              <upload @complete='setCover'>
                <img :src="cover||'/static/img/img01.jpg'">
              </upload>
              <li>
                <em char='6'>项目名</em>
              ...
              <li>
                ...
                <div class='outer layout-h icon zip'>
                  <input type="text" :value='proto' spellcheck="false">
                  <icon name='file' class='label'></icon>
                  <span class='placeholder' :alert='invalid'>请压缩成zip格式上传</span>
...
export default {
  ...
  methods: {
    save() {
      ...
      var self = this;
      this.$http.post('/api/axure/insert', {
        data: {
          name: self.name,
          cuser: self.cuser,
          cover: self.cover,
